...
const uri = "mongodb+srv://rlx:rlx@rlx4.lxsal.mongodb.net/myFirstDatabase?retryWrites=true&w=majority"
...
mongoose
  ...
  .then(console.log(`Connected to mongo db. Mongo link ${uri}`));
...
client.on("ready", () => {
  ...
  client.user.setActivity("m!help| playing dreams pt.2");
});
